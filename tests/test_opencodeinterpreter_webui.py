...
class TestOpenCodeInterpreterWebUI(unittest.TestCase):
    ...
    def test_webui_functions(self):
        ...
        # 期待される関数名
        webui_functions = [
            'create_interface', 'launch_app', 'setup_gradio',
            'build_ui', 'create_blocks', 'setup_components',
            'handle_code_execution', 'process_request', 'run_server'
        ]
    ...
    def test_ui_components(self):
        ...
        component_functions = [
            'create_text_input', 'create_code_editor', 'create_output_display',
            'setup_buttons', 'create_tabs', 'setup_layout'
        ]
