...
from nexuscore.archive.gradio_app import streamlit_migrated_tab as smt
...
def test_call_gpt_async_minimax_error(monkeypatch):
    ...
    with patch("nexuscore.archive.gradio_app.streamlit_migrated_tab.call_llm_messages", side_effect=RuntimeError("API error")):
