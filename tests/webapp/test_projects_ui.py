...
def test_projects_index_renders_with_cards(
    client, app, test_user, test_project, test_run_with_metrics
):
...
def test_project_detail_renders_with_metrics(
    client, app, test_user, test_project, test_run_with_metrics
):
...
def test_project_detail_shows_metrics_section(
    client, app, test_user, test_project, test_run_with_metrics
):
