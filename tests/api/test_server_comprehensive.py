...
with patch('nexuscore.api.server.Orchestrator'), \
    ...
    from nexuscore.api.server import app, tasks, run_orchestrator_task
...
class TestStatusEndpoint:
    ...
    def test_status_error_task(self, client, clear_tasks):
        ...
        tasks[task_id] = {
            "status": "error",
            "message": "orchestrator failed: Some error"
        }
...
class TestGithubWebhookEndpoint:
    ...
    def test_github_webhook_success(self, mock_handler, client):
        ...
        response = client.post('/api/github/webhook',
...
class TestRunOrchestratorTask:
    ...
    def test_run_orchestrator_task_success(
        self, mock_policy, mock_patcher, mock_curator, mock_postmortem,
        mock_guardian, mock_debugger, mock_tester, mock_coder,
        mock_planner, mock_architect, mock_orchestrator, clear_tasks
    ):
    ...
    def test_full_task_lifecycle(self, mock_thread, client, valid_token, clear_tasks):
        ...
        response = client.post('/api/v1/execute',
            ...
            json={
                ...
                'project_path': '/workspace/todoapp'
            }
        )
