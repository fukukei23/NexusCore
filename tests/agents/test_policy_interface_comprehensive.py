...
try:
    from nexuscore.ui.policy_interface import GRADIO_AVAILABLE, PolicyInterface
...
class TestCreateGradioInterface:
    ...
    def test_create_gradio_interface_returns_blocks(self, mock_gr):
        ...
        with patch("nexuscore.ui.policy_interface.GRADIO_AVAILABLE", True):
...
class TestLaunchAndWaitForInput:
    ...
    @patch("nexuscore.ui.policy_interface.PolicyInterface.create_gradio_interface")
