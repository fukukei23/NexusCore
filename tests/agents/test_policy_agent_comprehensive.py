...
class TestAudit:
    ...
    def test_audit_no_violations(self, mock_base_init, tmp_path):
        ...
        files_to_check = [{"path": "src/config.py", "content": "api_key = os.getenv('API_KEY')"}]
    ...
    def test_audit_with_violation(self, mock_base_init, tmp_path):
        ...
        files_to_check = [{"path": "src/config.py", "content": 'api_key = "sk-1234567890abcdef"'}]
    ...
    def test_audit_multiple_violations(self, mock_base_init, tmp_path):
        ...
        files_to_check = [
            {"path": "src/config.py", "content": 'api_key = "secret"\npassword = "12345"'}
        ]
    ...
    def test_audit_target_file_pattern(self, mock_base_init, tmp_path):
        ...
        files_to_check = [
            {"path": "src/module.py", "content": "print('debug')"},
            {"path": "tests/test_module.py", "content": "print('debug')"},
        ]
    ...
    def test_audit_no_policies_loaded(self, mock_base_init):
        ...
        files_to_check = [{"path": "src/code.py", "content": "any code"}]
    ...
    def test_audit_malformed_policy(self, mock_base_init, tmp_path):
        ...
        files_to_check = [{"path": "src/code.py", "content": "test line\nbad line"}]
