...
from nexuscore.archive.ui.nexus_dashboard import create_nexus_dashboard, launch_dashboard
...
class TestCreateNexusDashboard:
    @patch("nexuscore.archive.ui.nexus_dashboard.gr")
...
class TestAnalyzeProject:
    @patch("nexuscore.archive.ui.nexus_dashboard.assemble_agent_team")
...
class TestLaunchDashboard:
    @patch("nexuscore.archive.ui.nexus_dashboard.create_nexus_dashboard")
...
class TestMainBlock:
    ...
    @patch("nexuscore.archive.ui.nexus_dashboard.launch_dashboard")
...
class TestNexusDashboardIntegration:
    ...
    @patch("nexuscore.archive.ui.nexus_dashboard.gr")
    @patch("nexuscore.archive.ui.nexus_dashboard.assemble_agent_team", side_effect=ImportError("no agent"))
