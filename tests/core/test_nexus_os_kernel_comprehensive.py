...
class TestNexusOSKernelInit:
    ...
    def test_init_creates_all_modules(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
        """初期化時に全モジュールを作成"""
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_init_creates_services(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
        """初期化時にサービスレジストリを作成"""
        kernel = NexusOSKernel()
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_init_logs_boot_message(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe, caplog):
        """起動時にログメッセージを出力"""
...
class TestGetService:
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_get_service_search_tool(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_get_service_default_llm(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
        """デフォルトLLMサービスを取得"""
        kernel = NexusOSKernel()
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_get_service_unknown_raises_error(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
...
class TestDummyServices:
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_dummy_search_tool_has_search_method(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_dummy_search_tool_returns_results(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_dummy_llm_client_has_invoke_method(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_dummy_llm_client_returns_response(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
...
class TestSyscallExecuteCode:
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_execute_code_with_permission_granted(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
        """許可された場合にコードを実行"""
        # NPEが許可を返すようにモック
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_execute_code_permission_denied_raises_error(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_execute_code_logs_transaction(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
        """実行後にトランザクションをログ"""
        mock_permission = Mock()
        mock_permission.is_granted = True
        mock_npe.return_value.request_permission.return_value = mock_permission
...
class TestSyscallCommitFile:
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_commit_file_with_approval(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
        """レビュー承認後にファイルをコミット"""
        # NPEが許可
        mock_permission = Mock()
        mock_permission.is_granted = True
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_commit_file_permission_denied(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_commit_file_review_rejected(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_commit_file_tests_failed(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
...
class TestGetKernelSingleton:
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_get_kernel_returns_instance(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_get_kernel_returns_same_instance(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
...
class TestNexusOSKernelIntegration:
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_full_workflow_init_service_syscall(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
    ...
    @patch('nexuscore.core.nexus_os_kernel.SandboxRunner')
    @patch('nexuscore.core.nexus_os_kernel.TestGenerator')
    def test_services_are_cached(self, mock_testgen, mock_sandbox, mock_reviewer, mock_vcs, mock_npe):
        """サービスがキャッシュされる"""
        kernel = NexusOSKernel()
