...
import pytest
import os
from nexuscore.utils.cleaner import get_error_header, clean_error_msg, SITE_PKG_ERROR_PREFIX
...
ValueError: something went wrong"""
    ...
    def test_get_error_header_with_different_error_types(self):
        ...
        test_cases = [
            ...
            ("AttributeError: object has no attribute 'foo'", "AttributeError: object has no attribute 'foo'"),
        ]
...
RuntimeError: processing failed"""
        ...
        full_error = f"An error occurred while executing the following cell\n------------------\n{traceback}"
