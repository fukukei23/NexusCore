...
> **Canonical Architecture Document**: This is the detailed architectural design of NexusCore. For the Gate/SSOT entrypoint, see [docs/ARCHITECTURE.md](../ARCHITECTURE.md).
