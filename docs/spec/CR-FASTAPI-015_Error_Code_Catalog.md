...
- `docs/api/CR-FASTAPI-006_完了報告.md` - エラー標準化
- `docs/api/CR-FASTAPI-014_完了報告.md` - 認証エラー正規化
...
- `docs/api/エラーコードカタログ.md` - エラーコードカタログ（新規作成）
...
**変更内容**:
- make_error() / ショートカット関数の docstring に「詳細なエラーコード仕様は docs/api/エラーコードカタログ.md を参照」と明示
...
**実装内容**:
- エラーコードカタログ.md から error.code と HTTP ステータスの対応をパース
...
- 新規の error.code を増やす場合は、必ず エラーコードカタログ.md にも追記する
...
- [ ] 完了レポート作成（`docs/api/CR-FASTAPI-015_完了報告.md`）

## 7. 関連ドキュメント

- [CR-FASTAPI-006 Completion Report](../api/CR-FASTAPI-006_完了報告.md) - エラー標準化
- [CR-FASTAPI-014 Completion Report](../api/CR-FASTAPI-014_完了報告.md) - 認証エラー正規化
