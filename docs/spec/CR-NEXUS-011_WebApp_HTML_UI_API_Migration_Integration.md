...
- `docs/api/FastAPI移行ステータス.md` - FastAPI 移行状況
- `docs/api/CR-FASTAPI-010_完了報告.md` - Flask REST API 削除完了レポート
- `docs/api/CR-FASTAPI-010A_完了報告.md` - Badges パス統一完了レポート
...
1. **エンドポイント一覧ドキュメント作成**
   - `docs/api/WebApp_UI_API_マッピング.md` を作成
