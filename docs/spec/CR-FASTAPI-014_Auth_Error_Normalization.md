...
- `docs/api/CR-FASTAPI-004_完了報告.md` - 認証 DI 統一
- `docs/api/CR-FASTAPI-006_完了報告.md` - エラー標準化
- `docs/api/CR-FASTAPI-013_完了報告.md` - SDK E2E テスト基盤
...
- `docs/api/CR-FASTAPI-014_完了報告.md` - 完了レポート（新規作成）
...
- [CR-FASTAPI-004 Completion Report](../api/CR-FASTAPI-004_完了報告.md) - 認証 DI 統一
- [CR-FASTAPI-006 Completion Report](../api/CR-FASTAPI-006_完了報告.md) - エラー標準化
- [CR-FASTAPI-013 Completion Report](../api/CR-FASTAPI-013_完了報告.md) - SDK E2E テスト基盤
