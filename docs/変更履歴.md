...
- テスト6件（`tests/harness/test_harness_cli.py`）: exit 0/1写像・mock limits abort・state保存・policy不在fail-closed完走・未対応provider SystemExit・mock構築
- harness計測: 128件PASSED（Task 14の122件+今回6件）
