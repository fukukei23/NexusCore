...
```markdown
![Self-Healing Success Rate](https://img.shields.io/endpoint?url=https://your-nexuscore-host/api/v1/projects/1/badge/success_rate)
```
...
```markdown
![Last Run Status](https://img.shields.io/endpoint?url=https://your-nexuscore-host/api/v1/projects/1/badge/last_run)
```
