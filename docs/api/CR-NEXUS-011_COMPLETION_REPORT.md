...
**新規作成**:
- `docs/api/WEBAPP_UI_API_MAPPING.md`
...
- `docs/api/WEBAPP_UI_API_MAPPING.md` - 新規作成
...
2. **ドキュメントの充実**
   - `WEBAPP_UI_API_MAPPING.md` で各画面と FastAPI エンドポイントの対応関係を記載
   - 将来の開発者が理解しやすい状態になった
...
2. **ドキュメントの継続的な更新**
   - 新規 HTML UI 画面を作成する際は、`WEBAPP_UI_API_MAPPING.md` を更新
...
- [WEBAPP_UI_API_MAPPING.md](./WEBAPP_UI_API_MAPPING.md) - WebApp HTML UI と FastAPI API の対応関係
...
- [CR-FASTAPI-010 Completion Report](./CR-FASTAPI-010_COMPLETION_REPORT.md) - Flask REST API 削除完了レポート
- [CR-FASTAPI-010A Completion Report](./CR-FASTAPI-010A_COMPLETION_REPORT.md) - Badges パス統一完了レポート
