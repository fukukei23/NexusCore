...
- `docs/api/FastAPI移行ステータス.md` - 移行状況ドキュメント
...
- `docs/api/FastAPI移行ステータス.md` - Badges 行のパスを `/api/v1/projects/...` に更新、Notes 追記
...
- [CR-FASTAPI-007 Completion Report](./CR-FASTAPI-007_完了報告.md)
- [CR-FASTAPI-008 Completion Report](./CR-FASTAPI-008_完了報告.md)
- [CR-FASTAPI-009 Completion Report](./CR-FASTAPI-009_完了報告.md)
- [CR-FASTAPI-010 Completion Report](./CR-FASTAPI-010_完了報告.md)
