...
**エラーコードの単一のソース（Single Source of Truth）**: [ERROR_CODE_CATALOG.md](./ERROR_CODE_CATALOG.md)

すべてのエラーコードは `ERROR_CODE_CATALOG.md` に定義されています。新しいエラーコードを追加する場合は、必ず `ERROR_CODE_CATALOG.md` にも追記してください。
