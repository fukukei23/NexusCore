...
詳細は [FastAPI移行ステータス.md](./FastAPI移行ステータス.md) を参照してください。
...
- **WebApp HTML UI (Flask)**: サーバー内部 UI（人間向け HTML 画面）
  ...
  - 詳細は [WebApp_UI_API_マッピング.md](./WebApp_UI_API_マッピング.md) を参照してください
...
- **ファイル**: [CR-FASTAPI-000_プロンプト.md](./CR-FASTAPI-000_プロンプト.md)
- **目的**: 既存の Flask ベース API を全て棚卸しし、public / internal / 廃止候補を分類
- **出力**: `docs/api/APIインベントリ.md`
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-000_完了報告.md](./CR-FASTAPI-000_完了報告.md)

### CR-FASTAPI-001: FastAPI Skeleton
- **ファイル**: [CR-FASTAPI-001_プロンプト.md](./CR-FASTAPI-001_プロンプト.md)
- **目的**: FastAPI アプリケーションの最小スケルトンと `/api/v1/health` エンドポイントを作成
- **出力**: FastAPI アプリ本体、ルータ、スキーマ、テスト
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-001_完了報告.md](./CR-FASTAPI-001_完了報告.md)
- **追加改善レポート**: [CR-FASTAPI-001_機能強化報告.md](./CR-FASTAPI-001_機能強化報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-002_完了報告.md](./CR-FASTAPI-002_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-003_完了報告.md](./CR-FASTAPI-003_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-004_完了報告.md](./CR-FASTAPI-004_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-005_完了報告.md](./CR-FASTAPI-005_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-006_完了報告.md](./CR-FASTAPI-006_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-007_完了報告.md](./CR-FASTAPI-007_完了報告.md)
- **移行状況**: [FastAPI移行ステータス.md](./FastAPI移行ステータス.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-008_完了報告.md](./CR-FASTAPI-008_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-009_完了報告.md](./CR-FASTAPI-009_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-010_完了報告.md](./CR-FASTAPI-010_完了報告.md)
...
- **出力**: パス統一、ドキュメント更新
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-010A_完了報告.md](./CR-FASTAPI-010A_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-NEXUS-011_完了報告.md](./CR-NEXUS-011_完了報告.md)
- **関連ドキュメント**: [WebApp_UI_API_マッピング.md](./WebApp_UI_API_マッピング.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-NEXUS-032_完了報告.md](./CR-NEXUS-032_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-NEXUS-035_完了報告.md](./CR-NEXUS-035_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-NEXUS-036_完了報告.md](./CR-NEXUS-036_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-NEXUS-037_完了報告.md](./CR-NEXUS-037_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-NEXUS-038_完了報告.md](./CR-NEXUS-038_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-NEXUS-039_完了報告.md](./CR-NEXUS-039_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-NEXUS-040_完了報告.md](./CR-NEXUS-040_完了報告.md)
- **関連ドキュメント**: [プロジェクトAPI契約.md](./プロジェクトAPI契約.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-NEXUS-041_完了報告.md](./CR-NEXUS-041_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-NEXUS-043_完了報告.md](./CR-NEXUS-043_完了報告.md)
...
- **出力**: 内容品質ゲートテスト追加
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-NEXUS-044_完了報告.md](./CR-NEXUS-044_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-NEXUS-045_完了報告.md](./CR-NEXUS-045_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-NEXUS-046_完了報告.md](./CR-NEXUS-046_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-NEXUS-047_完了報告.md](./CR-NEXUS-047_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-NEXUS-048_完了報告.md](./CR-NEXUS-048_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-NEXUS-049_完了報告.md](./CR-NEXUS-049_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-NEXUS-050_完了報告.md](./CR-NEXUS-050_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-NEXUS-051_完了報告.md](./CR-NEXUS-051_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-NEXUS-052_完了報告.md](./CR-NEXUS-052_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-012_完了報告.md](./CR-FASTAPI-012_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-012A_完了報告.md](./CR-FASTAPI-012A_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-013_完了報告.md](./CR-FASTAPI-013_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-013A_完了報告.md](./CR-FASTAPI-013A_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-014_完了報告.md](./CR-FASTAPI-014_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-015_完了報告.md](./CR-FASTAPI-015_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-016_完了報告.md](./CR-FASTAPI-016_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-017_完了報告.md](./CR-FASTAPI-017_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-018_完了報告.md](./CR-FASTAPI-018_完了報告.md)
...
- **ステータス**: ✅ 完了
- **完了レポート**: [CR-FASTAPI-019_完了報告.md](./CR-FASTAPI-019_完了報告.md)
...
**エラーコードの単一のソース（Single Source of Truth）**: [エラーコードカタログ.md](./エラーコードカタログ.md)
...
詳細は [CR-FASTAPI-021 完了レポート](./CR-FASTAPI-021_完了報告.md) を参照してください。
...
詳細は [CR-FASTAPI-023 完了レポート](./CR-FASTAPI-023_完了報告.md) を参照してください。
