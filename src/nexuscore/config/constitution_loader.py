...
class ConstitutionLoader:
    ...
    _instance: Optional['ConstitutionLoader'] = None
    _constitution: Optional[Dict[str, Any]] = None
    ...
    def _load_constitution(self) -> Dict[str, Any]:
        ...
        if not constitution_path or not constitution_path.exists():
            logger.warning(f"憲法ファイルが見つかりません: {constitution_path}. デフォルトを使用します。")
            return self._get_default_constitution()
    ...
    def _find_constitution_file(self) -> Optional[Path]:
        """
        憲法ファイルを検索
    ...
    def _get_default_constitution(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "fkb": {
                "learning": {
                    "enabled": True,
                    "trigger_on_debugger_failure": True
                }
            }
        }
...
_loader_instance: Optional[ConstitutionLoader] = None
