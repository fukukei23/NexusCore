...
# === NexusCore/tools\exports\export_20250803_114325\source_code\NexusCore\exported_projects\app_20250703_223016\app\routes.py ===
from flask import Blueprint, render_template, redirect, url_for, request, flash, Response
from app import db
from app.models import Product
from app.forms import ProductForm
...
# === NexusCore/tools\exports\export_20250803_114325\source_code\NexusCore\exported_projects\project_export_m73owrzi\app\routes.py ===
from flask import Blueprint, render_template, redirect, url_for, request, flash, Response
from app import db
from app.models import Product
from app.forms import ProductForm
...
# === NexusCore/tools\exports\export_20250803_114325\source_code\NexusCore\exported_projects\project_export_xb_l70t8\app\routes.py ===
from flask import Blueprint, render_template, redirect, url_for, request, flash, Response
from app import db
from app.models import Product
from app.forms import ProductForm
...
# === NexusCore/tools\exports\export_20250803_114325\source_code\NexusCore\exported_projects\project_export_y7xxp1v8\app\routes.py ===
from flask import Blueprint, render_template, redirect, url_for, request, flash, Response
from app import db
from app.models import Product
from app.forms import ProductForm
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\exported_projects\app_20250703_223016\app\routes.py ===
from flask import Blueprint, render_template, redirect, url_for, request, flash, Response
from app import db
from app.models import Product
from app.forms import ProductForm
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\exported_projects\project_export_m73owrzi\app\routes.py ===
from flask import Blueprint, render_template, redirect, url_for, request, flash, Response
from app import db
from app.models import Product
from app.forms import ProductForm
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\exported_projects\project_export_xb_l70t8\app\routes.py ===
from flask import Blueprint, render_template, redirect, url_for, request, flash, Response
from app import db
from app.models import Product
from app.forms import ProductForm
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\exported_projects\project_export_y7xxp1v8\app\routes.py ===
from flask import Blueprint, render_template, redirect, url_for, request, flash, Response
from app import db
from app.models import Product
from app.forms import ProductForm
...
# === NexusCore/tools\exports\export_20250803_114325\source_code\NexusCore\src\opencodeinterpreter_webui.py ===
# 📁 ファイル名: opencodeinterpreter_webui.py
# 📂 フォルダ構成: /src/opencodeinterpreter_webui.py
# 🕠 目的: Gradio UIにユニットテスト生成 + 修正サイクル + テスト一括実行を統合
...
# === NexusCore/tools\exports\export_20250803_114325\source_code\NexusCore\src\api\server.py ===
# ==============================================================================
# フォルダ: src/api
# ファイル名: server.py
# メモ: NexusCoreの機能を外部に公開するためのFlask APIサーバー。
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\src\opencodeinterpreter_webui.py ===
# 📁 ファイル名: opencodeinterpreter_webui.py
# 📂 フォルダ構成: /src/opencodeinterpreter_webui.py
# 🕠 目的: Gradio UIにユニットテスト生成 + 修正サイクル + テスト一括実行を統合
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\src\api\server.py ===
# ==============================================================================
# フォルダ: src/api
# ファイル名: server.py
# メモ: NexusCoreの機能を外部に公開するためのFlask APIサーバー。
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\tools\exports\export_20250803_114325\source_code\NexusCore\src\api\server.py ===
# ==============================================================================
# フォルダ: src/api
# ファイル名: server.py
# メモ: NexusCoreの機能を外部に公開するためのFlask APIサーバー。
...
# === NexusCore/src\nexuscore\gradio_app\revision_loop.py ===
...
# === NexusCore/tools\exports\export_20250803_114325\source_code\NexusCore\src\gradio_app\revision_loop.py ===
# OpenCodeInterpreter 拡張：反復AI修正ループ・バージョン管理付きGradioアプリ
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\src\gradio_app\revision_loop.py ===
# OpenCodeInterpreter 拡張：反復AI修正ループ・バージョン管理付きGradioアプリ
...
# === NexusCore/tools\exports\export_20250803_114325\source_code\NexusCore\healing_sandbox\src\agents\patch_applier.py ===
# ==============================================================================
# フォルダ: src/agents
# ファイル名: patch_applier.py
# メモ: 内部ロジックを簡素化し、OS標準の`patch`コマンドを直接呼び出すことで
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\healing_sandbox\src\agents\patch_applier.py ===
# ==============================================================================
# フォルダ: src/agents
# ファイル名: patch_applier.py
# メモ: 内部ロジックを簡素化し、OS標準の`patch`コマンドを直接呼び出すことで
