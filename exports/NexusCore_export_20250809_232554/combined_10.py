...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\app\routes.py ===
# app/routes.py
from flask import Blueprint, render_template, redirect, url_for, request, flash, Response
from app import db
from app.models import Product                      # ← models.py で定義した ORM クラス[1]
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\tools\exports\export_20250803_114325\source_code\NexusCore\app\routes.py ===
# app/routes.py
from flask import Blueprint, render_template, redirect, url_for, request, flash, Response
from app import db
from app.models import Product                      # ← models.py で定義した ORM クラス[1]
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\exported_projects\app_20250703_223016\app\utils\generate_descriptions.py ===
import os
import requests
import csv
import time
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\exported_projects\project_export_m73owrzi\app\utils\generate_descriptions.py ===
import os
import requests
import csv
import time
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\exported_projects\project_export_xb_l70t8\app\utils\generate_descriptions.py ===
import os
import requests
import csv
import time
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\exported_projects\project_export_y7xxp1v8\app\utils\generate_descriptions.py ===
import os
import requests
import csv
import time
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\healing_sandbox\src\agents\debugger_agent.py ===
# ==============================================================================
# フォルダ: src/agents
# ファイル名: debugger_agent.py
# メモ: FKBの'target'ヒントを解釈し、「修正計画」を返す分析官にアップグレード。
...
# === NexusCore/src\nexuscore\agents\architect_agent.py ===
# ==============================================================================
...
# === NexusCore/src\nexuscore\agents\postmortem_agent.py ===
# ==============================================================================
# フォルダ: src/agents
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\src\agents\postmortem_agent.py ===
# ==============================================================================
# フォルダ: src/agents
# ファイル名: postmortem_agent.py
# メモ: 【思考プロセス強化版】生成するFKBのsolution_patternが、
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\src\gradio_app\app_ui.py ===
# src/gradio_app/app_ui.py
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\src\utils\file_utils.py ===
# ==============================================================================
# フォルダ: src/utils
# ファイル名: file_utils.py
# メモ: ArchitectAgentが生成した詳細な設計図（ファイルとフォルダのリスト）を
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\tools\exports\export_20250803_114325\source_code\NexusCore\src\gradio_app\app_ui.py ===
# src/gradio_app/app_ui.py
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\tools\exports\export_20250803_114325\source_code\NexusCore\src\utils\file_utils.py ===
# ==============================================================================
# フォルダ: src/utils
# ファイル名: file_utils.py
# メモ: ArchitectAgentが生成した詳細な設計図（ファイルとフォルダのリスト）を
...
# === NexusCore/src\nexuscore\agents\guardian_agent.py ===
import json
import git
from .base_agent import BaseAgent
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\src\agents\guardian_agent.py ===
import json
import git
from .base_agent import BaseAgent
from src.utils.vcs import GitController
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\tools\exports\export_20250803_114325\source_code\NexusCore\src\agents\guardian_agent.py ===
import json
import git
from .base_agent import BaseAgent
from src.utils.vcs import GitController
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\data_collection\Local-Code-Interpreter\src\cli.py ===
from response_parser import *
import copy
import json
from tqdm import tqdm
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\data_collection\Local-Code-Interpreter\src\jupyter_backend.py ===
import jupyter_client
import re
...
# === NexusCore/src\nexuscore\agents\knowledge_curator_agent.py ===
# ==============================================================================
# フォルダ: src/agents
...
# === NexusCore/tools\exports\NexusCore_export_20250803_131253\source_code\NexusCore\src\agents\knowledge_curator_agent.py ===
# ==============================================================================
# フォルダ: src/agents
# ファイル名: knowledge_curator_agent.py
# メモ: 【情報伝達修正版】検証プロセスにおいて、PostmortemAgentが分析した
