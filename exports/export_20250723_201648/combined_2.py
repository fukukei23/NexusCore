...
# === tree_sitter_languages/tree-sitter-python\test\highlight\pattern_matching.py ===
match command.split():
# ^ keyword
    case ["quit"]:
    # ^ keyword
...
# === tree_sitter_languages/tree-sitter-python\bindings\python\tree_sitter_python\__init__.py ===
...
# === tree_sitter_languages/tree-sitter-python\examples\tabs.py ===
...
# === tree_sitter_languages/tree-sitter-python\test\highlight\keywords.py ===
if foo():
# <- keyword
    pass
    # <- keyword
...
# === tree_sitter_languages/tree-sitter-python\test\tags\main.py ===
class MyClass:
  #    ^ definition.class
  def hello():
    #  ^ definition.function
...
# === tree_sitter_languages/tree-sitter-python\examples\trailing-whitespace.py ===
print a    
...
# === tree_sitter_languages/tree-sitter-python\test\highlight\parameters.py ===
...
# === tree_sitter_languages/tree-sitter-python\bindings\python\tests\test_binding.py ===
...
# === vscode-extension/python\tree_sitter_checker.py ===
